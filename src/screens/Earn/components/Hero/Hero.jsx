    ...
    return (
        <>
            <div className="hero" style={{ backgroundImage: `url()` }}>
                ...
                <h1 className="textHeading1">Farms V2</h1>
                    {/* Hero Subheading */}
                    {/*
                    ...
                    */}
                    ...
                    <div className="heroHeading2 flex">
                        <h2 className="textHeading2">Coming Soon!</h2>
                    </div>
                    */}
                    {/*
                    <div className="heroItemsMany flex">
                        <div className="heroItemsLeft flex">
                            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="sc-iCoGMd nVICa">
                            ...
                            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="sc-iCoGMd ezJoGw">
                                ...
                                <Collapsible
                                    headerContent={
                                        <div className="flex rightH1">
                                            ...
                                            <span>
                                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="sc-iCoGMd iZDSCZ">
